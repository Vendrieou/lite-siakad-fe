      ...
      >
        <div className={styles.container}>
          <div>
            ...
            {/* <ProFormText width="md" name="tglLahir" label="TANGGAL" placeholder="Masukkan tgl. lahir" /> */}
            {/* <DatePicker width="md" name="tglLahir" label="TANGGAL" placeholder="Masukkan tgl. lahir" /> */}
          ...
          <div>
            <h3>BAG 4</h3>
            {/* <ProFormText width="md" name="biayaKuliah" label="BIAYA KULIAH PER TAHUN" placeholder="Rp" />
            <ProFormText width="md" name="diskon" label="DISKON" /> */}
            ...
            <ol className={styles.m}>
              <li>
                {/* <ProFormText width="md" name="pembayaranCicilan" label="PEMBAYARAN CICILAN" placeholder="" /> */}
                <ProFormText width="md" name="pembayaranCicilan" label="PEMBAYARAN CICILAN" fieldProps={{ prefix: "Rp" }} placeholder="" disabled />
              </li>
              <li>
                {/* <ProFormText width="md" name="uangPendaftaran" label="UANG PENDAFTARAN" placeholder="" /> */}
                <ProFormText width="md" name="uangPendaftaran" label="UANG PENDAFTARAN" fieldProps={{ prefix: "Rp" }} placeholder="" disabled />
              </li>
              <li>
                {/* <ProFormText width="md" name="biayaLain" label="BIAYA LAIN-LAIN" placeholder="" /> */}
